...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const NomeValorProduto = () => {
    ...
    const botaoEnviar7 = document.querySelector(".concluir2");

    // Verifique se o botão foi encontrado antes de prosseguir
    if (botaoEnviar7) {
      // Obtenha os atributos do botão
      const produto = botaoEnviar7.getAttribute('data-text3');
      const valor = parseFloat(botaoEnviar7.getAttribute('data-value3'));
